...
const styles = StyleSheet.create({
  ...
  subtitle: { marginTop: 2, color: "#748397", fontSize: 14, lineHeight: 20, textAlign: "center" },
  phoneCard: { alignItems: "center", backgroundColor: "#FFFFFF", borderRadius: 15, flexDirection: "row", marginTop: 8, paddingHorizontal: 16, paddingVertical: 14, shadowColor: "#6D8792", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 8, elevation: 2 },
  phone: { color: "#102B3D", flex: 1, fontSize: 15, fontWeight: "600", marginLeft: 9 },
  change: { color: "#009C91", fontSize: 13, fontWeight: "700" },
  codeCells: { flexDirection: "row", justifyContent: "space-between", marginTop: 14 },
  codeCell: { alignItems: "center", backgroundColor: "#FFFFFF", borderColor: "#D9E2E8", borderRadius: 12, borderWidth: 1, justifyContent: "center", minHeight: 52, width: 46 },
  ...
  validity: { color: "#748397", fontSize: 12, marginTop: 8, textAlign: "center" },
  error: { color: "#B3261E", fontSize: 12, lineHeight: 17, marginTop: 11, textAlign: "center" },
  verifyButton: { alignItems: "center", backgroundColor: "#00A99D", borderRadius: 15, justifyContent: "center", marginTop: 12, minHeight: 50 },
  buttonDisabled: { opacity: 0.6 },
  verifyLabel: { color: "#FFFFFF", fontSize: 16, fontWeight: "700" },
  resendHint: { color: "#506275", fontSize: 12, marginTop: 16, textAlign: "center" },
  resendButton: { alignItems: "center", marginTop: 2, paddingVertical: 5 },
  resendButtonDisabled: { opacity: 0.5 },
  resendLabel: { color: "#009C91", fontSize: 13, fontWeight: "700" },
  resendLabelDisabled: { color: "#748397" },
  backButton: { alignItems: "center", alignSelf: "center", flexDirection: "row", marginTop: 6, padding: 6 },
