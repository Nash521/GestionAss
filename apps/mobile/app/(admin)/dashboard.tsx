...
const styles = StyleSheet.create({
  ...
  header: { alignItems: "center", flexDirection: "row", justifyContent: "space-between", left: 0, paddingHorizontal: 20, position: "absolute", right: 0, top: 28, zIndex: 10 }, headerAction: { alignItems: "center", backgroundColor: "#FFF", borderRadius: 16, elevation: 4, height: 46, justifyContent: "center", shadowColor: "#102B3D", shadowOpacity: .14, shadowRadius: 8, width: 46 }, logo: { height: 64, resizeMode: "contain", width: 64 },
