...
import { AdminMemberDetail, ContributionDue, getAdminMemberDetail } from "../../../src/lib/supabase";
...
function MemberContent({ detail }: { detail: AdminMemberDetail }) {
  ...
  return <>
    ...
    <Section title="Total cotisé"><View style={styles.amountGrid}><AmountCard label="Total" value={money(summary.totalContributed)} /><AmountCard label="Mensuel" value={money(summary.monthlyPaid)} /><AmountCard label="Exceptionnel" value={money(summary.exceptionalPaid)} /></View></Section>
