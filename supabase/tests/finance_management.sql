...
select ok(public.get_admin_finance('51000000-0000-0000-0000-000000000001', 'monthly', 0, 50)->'items'->0 ?& array['firstName', 'lastName', 'phone'], 'monthly finance includes member identity and phone');
